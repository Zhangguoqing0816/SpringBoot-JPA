...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    //项目启动时此方法会先被注册成 Bean 被 Spring 管理，
    //如果没有这个 bean ，则 redis 可视化工具中的中文内容（key 或者 value ） 都会以二级制存储，不易检查
    @Bean
    public RedisTemplate<String, RedisModel> redisTemplate(RedisConnectionFactory factory){
